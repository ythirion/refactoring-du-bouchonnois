...
- On va extraire une méthode à partir de celà en identifiant les similitudes et différences
```csharp
...
- On peut maintenant approver le résultat du test qui ressemble à celà
