...
- En faisant celà, on brise une règle d'architecture définie précédemment :
...
Nouveau rapport `SonarCloud` disponible [ici](https://sonarcloud.io/summary/overall?id=ythirion_refactoring-du-bouchonnois&branch=steps%2F12-event-sourcing).
