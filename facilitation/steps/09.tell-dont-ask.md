...
![22 failing tests](img/09.tell-dont-ask/22-failing-tests.webp)
...
![Backing fields](img/09.tell-dont-ask/backing-field.webp)
...
![Change factory](img/09.tell-dont-ask/change-factory.webp)
...
- La méthode `Tirer` ressemble à celà
...
![Invert if](img/09.tell-dont-ask/invert-if.webp)
...
![No more duplication](img/09.tell-dont-ask/no-more-duplication.webp)
