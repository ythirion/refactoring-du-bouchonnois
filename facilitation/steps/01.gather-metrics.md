...
C'est un outil de [mutation testing] signifiant qu'il va créant des versions mutantes de notre code de production et vérifier que les tests vont bien identifier ces mutants (au moins 1 test doit échouer pour chaque mutant généré).
